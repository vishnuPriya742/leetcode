<h2><a href="https://leetcode.com/problems/maximum-score-after-binary-swaps">Maximum Score After Binary Swaps</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given an integer array <code>nums</code> of length <code>n</code> and a binary string <code>s</code> of the same length.</p>
